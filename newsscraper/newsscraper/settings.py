...
ITEM_PIPELINES = {
    "newsscraper.pipelines.FallbackUrlPipeline": 300,
}
...
FEEDS = {
    # The path is relative to the project's root directory (where scrapy.cfg is)
    'scraped_data.jsonl': {
        'format': 'jsonlines',  # Use jsonlines for line-by-line JSON
        'encoding': 'utf8',
        'store_empty': False,   # Don't create a file if no items are scraped
        'overwrite': True,      # This replaces the behavior of the -O flag
    },
}
